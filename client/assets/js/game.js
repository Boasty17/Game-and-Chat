var game = new Phaser.Game(1200,800, Phaser.AUTO, 'phaser-demo', {preload: preload, create: create, update: update, render: render});
...
var MAXSPEED = 400;
function preload() {
    game.load.image('starfield', '../assets/image/starfield.png');
    game.load.image('ship', '../assets/image/blue2.png');
    game.load.image('bullet', '../assets/image/bullet.png');
    game.load.image('enemy-green', '../assets/image/enemy-green.png');
    game.load.spritesheet('explosion', '../assets/image/explode.png', 128, 128);
}

function create() {
    //  The scrolling starfield background
    starfield = game.add.tileSprite(0, 0, 1500, 800, 'starfield');
    ...
    shipTrail = game.add.emitter(player.x, player.y + 60, 400);
    shipTrail.width = 10;
